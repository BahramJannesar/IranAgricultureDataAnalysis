...
در وب سایت FAO می توانید داده های مربوط به غذاها و کشاورزی را در کدام سال مورد نظر خود بیابید ، تمام این مجموعه داده ها در این [لینک] موجود است (http://www.fao.org/faostat/fa/؟#data )
همه داده های ایران را در این repo جمع آوری کرده ایم و برخی از آنها را همانطور که می بینید تجزیه و تحلیل کردیم.
